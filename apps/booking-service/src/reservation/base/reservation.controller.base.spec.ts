  ...
  test("POST /reservations", async () => {
    await request(app.getHttpServer())
      ...
      .expect({
        ...
        dateFrom: CREATE_RESULT.dateFrom.toISOString(),
        dateTo: CREATE_RESULT.dateTo.toISOString(),
      ...
      .expect([
        {
          ...
          dateFrom: FIND_MANY_RESULT[0].dateFrom.toISOString(),
          dateTo: FIND_MANY_RESULT[0].dateTo.toISOString(),
  ...
  test("GET /reservations/:id existing", async () => {
    await request(app.getHttpServer())
      ...
      .expect({
        ...
        dateFrom: FIND_ONE_RESULT.dateFrom.toISOString(),
        dateTo: FIND_ONE_RESULT.dateTo.toISOString(),
